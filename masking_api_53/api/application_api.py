...
class ApplicationApi(object):
    ...
    def get_application(self, application_name, **kwargs):  # noqa: E501
        """Get application by name [INCUBATING]  # noqa: E501
        ...
        :param async_req bool
        :param str application_name: The name of the application to get (required)
        :return: Application
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_application_with_http_info(application_name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_application_with_http_info(application_name, **kwargs)  # noqa: E501
            return data

    def get_application_with_http_info(self, application_name, **kwargs):  # noqa: E501
        """Get application by name [INCUBATING]  # noqa: E501

        Incubating endpoints are subject to changes that may or may not maintain backwards-compatibility.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_application_with_http_info(application_name, async_req=True)
        >>> result = thread.get()
        ...
        if ('application_name' not in params or
            ...
            raise ValueError("Missing the required parameter `application_name` when calling `get_application`")  # noqa: E501
