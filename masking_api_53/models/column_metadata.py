...
class ColumnMetadata(object):
    ...
    attribute_map = {
        ...
        'xml_file_format_id': 'xmlFileFormatId'
    }

    def __init__(self, column_metadata_id=None, column_name=None, table_metadata_id=None, algorithm_name=None, domain_name=None, data_type=None, date_format=None, column_length=None, is_masked=None, is_profiler_writable=False, is_primary_key=None, is_index=None, is_foreign_key=None, notes=None, xml_data_source=None, xml_file_format_id=None):  # noqa: E501
        ...
        self._notes = None
        self._xml_data_source = None
        self._xml_file_format_id = None
        ...
        if notes is not None:
            self.notes = notes
        if xml_data_source is not None:
            self.xml_data_source = xml_data_source
        if xml_file_format_id is not None:
            self.xml_file_format_id = xml_file_format_id
    ...
    @property
    def xml_data_source(self):
        """Gets the xml_data_source of this ColumnMetadata.  # noqa: E501

        This field is used to indicate where XML content should be pulled from.  This field is only relevant when using XML data for a CLOB column, otherwise it should be left null.  # noqa: E501

        :return: The xml_data_source of this ColumnMetadata.  # noqa: E501
        :rtype: str
        """
        return self._xml_data_source

    @xml_data_source.setter
    def xml_data_source(self, xml_data_source):
        """Sets the xml_data_source of this ColumnMetadata.

        This field is used to indicate where XML content should be pulled from.  This field is only relevant when using XML data for a CLOB column, otherwise it should be left null.  # noqa: E501

        :param xml_data_source: The xml_data_source of this ColumnMetadata.  # noqa: E501
        :type: str
        """
        allowed_values = ["TABLE", "FILE_FORMAT"]  # noqa: E501
        if xml_data_source not in allowed_values:
            raise ValueError(
                "Invalid value for `xml_data_source` ({0}), must be one of {1}"  # noqa: E501
                .format(xml_data_source, allowed_values)
            )

        self._xml_data_source = xml_data_source

    @property
    def xml_file_format_id(self):
        """Gets the xml_file_format_id of this ColumnMetadata.  # noqa: E501

        This field is used to reference an XML file format. This field is only relevant when the user-defined 'xmlDataSource' is FILE_FORMAT.  # noqa: E501

        :return: The xml_file_format_id of this ColumnMetadata.  # noqa: E501
        :rtype: int
        """
        return self._xml_file_format_id

    @xml_file_format_id.setter
    def xml_file_format_id(self, xml_file_format_id):
        """Sets the xml_file_format_id of this ColumnMetadata.

        This field is used to reference an XML file format. This field is only relevant when the user-defined 'xmlDataSource' is FILE_FORMAT.  # noqa: E501

        :param xml_file_format_id: The xml_file_format_id of this ColumnMetadata.  # noqa: E501
        :type: int
        """

        self._xml_file_format_id = xml_file_format_id
