...
class ConnectionInfo(object):
    ...
    def __init__(self, connection_mode=None, path=None, host=None, login_name=None, password=None, port=None, ssh_key=None):  # noqa: E501
    ...
    def connection_mode(self, connection_mode):
        ...
        allowed_values = ["FTP", "SFTP"]  # noqa: E501
    ...
    def host(self, host):
        ...
        :type: str
        """
        if host is not None and len(host) > 50:
            raise ValueError("Invalid value for `host`, length must be less than or equal to `50`")  # noqa: E501
    ...
    def password(self, password):
        ...
        :type: str
        """
        if password is not None and len(password) > 45:
            raise ValueError("Invalid value for `password`, length must be less than or equal to `45`")  # noqa: E501
