...
class DataCleansingExtension(object):
    ...
    def file_reference_id(self):
        ...
        The reference UUID value returned from the endpoint for uploading files to the Masking Engine. The file should contain a newline separated list of {value, replacement} pairs separated by the delimiter. No extraneous whitespace should be present.  # noqa: E501
