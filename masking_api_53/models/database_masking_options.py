...
class DatabaseMaskingOptions(object):
    ...
    def __init__(self, batch_update=True, bulk_data=False, commit_size=None, disable_constraints=False, drop_indexes=False, disable_triggers=False, num_output_threads_per_stream=1, truncate_tables=False, prescript=None, postscript=None):  # noqa: E501
    ...
    @property
    def bulk_data(self):
        """Gets the bulk_data of this DatabaseMaskingOptions.  # noqa: E501

        This field determines whether the database masking phase will be done via bulk data. The process for bulk data masking is to export the data being masked into a file, read the data file into memory, mask the data file in memory, and then import the masked data from the file back into the database. This process typically results in better masking job performance than normal, but the masking job must consume a very large amount of memory during the process, so this option should be used with caution. Note that this option is not applicable to OnTheFly masking jobs.  # noqa: E501

        :return: The bulk_data of this DatabaseMaskingOptions.  # noqa: E501
        :rtype: bool
        """
        return self._bulk_data

    @bulk_data.setter
    def bulk_data(self, bulk_data):
        """Sets the bulk_data of this DatabaseMaskingOptions.

        This field determines whether the database masking phase will be done via bulk data. The process for bulk data masking is to export the data being masked into a file, read the data file into memory, mask the data file in memory, and then import the masked data from the file back into the database. This process typically results in better masking job performance than normal, but the masking job must consume a very large amount of memory during the process, so this option should be used with caution. Note that this option is not applicable to OnTheFly masking jobs.  # noqa: E501

        :param bulk_data: The bulk_data of this DatabaseMaskingOptions.  # noqa: E501
        :type: bool
        """

        self._bulk_data = bulk_data
