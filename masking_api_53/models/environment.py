...
class Environment(object):
    ...
    def __init__(self, environment_id=None, environment_name=None, application=None, purpose=None, is_workflow_enabled=False):  # noqa: E501
    ...
    def application(self):
        """Gets the application of this Environment.  # noqa: E501

        The name of the Application that this Environment is associated with. Note that the Application must already exist when attempting to create the Environment.  # noqa: E501

        :return: The application of this Environment.  # noqa: E501
        :rtype: str
        """
    ...
    def application(self, application):
        """Sets the application of this Environment.

        The name of the Application that this Environment is associated with. Note that the Application must already exist when attempting to create the Environment.  # noqa: E501

        :param application: The application of this Environment.  # noqa: E501
        :type: str
        """
        if application is None:
            raise ValueError("Invalid value for `application`, must not be `None`")  # noqa: E501
        if application is not None and len(application) > 255:
