...
class MaskingJob(object):
    ...
    def __init__(self, masking_job_id=None, job_name=None, ruleset_id=None, created_by=None, created_time=None, email=None, feedback_size=None, job_description=None, max_memory=None, min_memory=None, multi_tenant=False, num_input_streams=1, on_the_fly_masking=False, database_masking_options=None, on_the_fly_masking_source=None, fail_immediately=False):  # noqa: E501
