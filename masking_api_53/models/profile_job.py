...
class ProfileJob(object):
    ...
    def __init__(self, profile_job_id=None, job_name=None, profile_set_id=None, ruleset_id=None, created_by=None, created_time=None, email=None, feedback_size=None, job_description=None, max_memory=None, min_memory=None, multi_tenant=False, num_input_streams=1, multiple_profiler_check=False):  # noqa: E501
